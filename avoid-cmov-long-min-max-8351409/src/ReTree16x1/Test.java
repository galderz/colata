...
final class Test {
  ...
  static long test(long[] array) {
    ...
    for (int i = 0; i < array.length; i += 16) {
      ...
      var t2 = Math.max(v4, v5);
      var t3 = Math.max(v6, v7);
      var t4 = Math.max(v8, v9);
      var t5 = Math.max(v10, v11);
      var t6 = Math.max(v12, v13);
      var t7 = Math.max(v14, v15);
      var t8 = Math.max(t0, t1);
      var t9 = Math.max(t2, t3);
      var t10 = Math.max(t4, t5);
      var t11 = Math.max(t6, t7);
      var t12 = Math.max(t8, t9);
      var t13 = Math.max(t10, t11);
      var t14 = Math.max(t12, t13);
