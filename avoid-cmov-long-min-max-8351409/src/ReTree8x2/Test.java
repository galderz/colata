...
final class Test {
  ...
  static long test(long[] array) {
    ...
    for (int i = 0; i < array.length; i += 16) {
      ...
      var t4 = Math.max(t0, t1);
      var t5 = Math.max(t2, t3);
      var t6 = Math.max(t4, t5);
      ...
      var v14 = array[i + 14];
      var v15 = array[i + 15];
      var t7 = Math.max(v8, v9);
      var t8 = Math.max(v10, v11);
      var t9 = Math.max(v12, v13);
      var t10 = Math.max(v14, v15);
      var t11 = Math.max(t7, t8);
      var t12 = Math.max(t9, t10);
      var t13 = Math.max(t11, t12);
      result = Math.max(result, t13);
    }
    return result;
  }
