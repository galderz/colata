...
final class Test {
  ...
  static long test(long[] array) {
    ...
    for (int i = 0; i < array.length; i += 16) {
      ...
      result = Math.max(result, t0);
      var v2 = array[i + 2];
      var v3 = array[i + 3];
      var t2 = Math.max(v3, v2);
      result = Math.max(result, t2);
      var v4 = array[i + 4];
      var v5 = array[i + 5];
      var t4 = Math.max(v5, v4);
      result = Math.max(result, t4);
      var v6 = array[i + 6];
      var v7 = array[i + 7];
      var t6 = Math.max(v7, v6);
      ...
      var v10 = array[i + 10];
      var v11 = array[i + 11];
      var t10 = Math.max(v11, v10);
      result = Math.max(result, t10);
      var v12 = array[i + 12];
      var v13 = array[i + 13];
      var t12 = Math.max(v13, v12);
      result = Math.max(result, t12);
      var v14 = array[i + 14];
      var v15 = array[i + 15];
      var t14 = Math.max(v15, v14);
