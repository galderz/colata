...
- [ ] check the performance of manual unroll 16 and compare with prototype
...
- [ ] see if an IR test can be developed, though IR node shape is not a feature (according to roland)
* 16.9.26
** patch assembly
