...
benchmark()
{
    ...
    log TEST=\"micro:org\.openjdk\.bench\.java\.lang\.MinMaxVector\.\\\(?:float\\\|double\\\)\" MICRO=\"OPTIONS=-jvmArgsAppend -XX:-UseSuperWord -rff ${rff_prefix}-mmv.csv ${extra_args} ${common_args}\" CONF=release LOG=warn make test
}
