...
PREVIEW_FLAGS="-Dformat.skip=true -Dforbiddenapis.skip=true"
...
echo ""
echo "============================================================"
echo "Phase 2a: Building panache-hibernate-common (JDK 28, no --enable-preview)"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Phase 2b: Building extensions/hibernate-orm (JDK 28, no --enable-preview)"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Phase 2a: Building panache-hibernate-common (no --enable-preview)"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Phase 2b: Building extensions/hibernate-orm (no --enable-preview)"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Phase 2c: Building hibernate-orm-panache-common (no --enable-preview)"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Phase 2d: Building hibernate-orm-panache (no --enable-preview)"
echo "============================================================"
