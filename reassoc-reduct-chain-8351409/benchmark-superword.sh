...
benchmark_all()
{
    ...
    log TEST=\"micro:org\.openjdk\.bench\.vm\.compiler\.VectorReduction2\.WithSuperword\" MICRO=\"OPTIONS=-rff ${rff_prefix}-vr2.csv ${extra_args}\" CONF=release LOG=warn make test
